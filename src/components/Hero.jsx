  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(circle, rgba(57,177,209,0.14) 1.2px, transparent 1.2px)',
      ...
      <div style={{
        position: 'absolute', inset: 0, pointerEvents: 'none',
        background: 'radial-gradient(ellipse 68% 52% at 50% 44%, rgba(57,177,209,0.06) 0%, transparent 70%)',
      }} />
      ...
      <div className="float-a" style={{
        ...
        background: 'radial-gradient(circle, rgba(57,177,209,0.10) 0%, transparent 70%)',
        filter: 'blur(54px)',
      }} />
      <div className="float-b" style={{
        position: 'absolute', bottom: '14%', right: '-7%',
        width: 420, height: 420, borderRadius: '50%', pointerEvents: 'none',
        background: 'radial-gradient(circle, rgba(57,177,209,0.06) 0%, transparent 70%)',
        filter: 'blur(68px)',
      }} />
      <div style={{
        position: 'absolute', top: '55%', left: '55%',
        width: 320, height: 320, borderRadius: '50%', pointerEvents: 'none',
        background: 'radial-gradient(circle, rgba(57,177,209,0.04) 0%, transparent 70%)',
